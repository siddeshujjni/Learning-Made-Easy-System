...
angular.module('sbAdminApp')
  .controller('GradesStuCtrl', function($scope,$position,$http,$state) {

		//Get the grades information
		var getAllGrades = {
	    method: 'GET',
	  	url: 'http://127.0.0.1:8080/answers/'+localStorage.ID + '/student/' + localStorage.CID + '/course'
		}; 
    ...
    var getTotalGrade = {
      method: 'GET',
      url: 'http://127.0.0.1:8080/reg/' + localStorage.ID
    }; 
